         ...
         <div class="column">
             <div class="card">
                    ...
                    <v-form ref="form" v-model="valid" lazy-validation>
                        ...
                        <v-btn @click="clear" color="red" dark style="margin-left: auto">clear</v-btn>
                        <v-btn
                        :disabled="!valid"
                        @click="submit"
                        color="blue"
  ...
  methods: {
    submit () {
      if (this.$refs.form.validate()) {
        ...
        this.$http.post(this.$apiUrl + 'changepassword/' + localStorage.getItem('id'), this.data, config).then(response => {
